...
var Game = cc.Class({
    ...
    update: function (dt) {
        ...
        // 就会调用游戏失败逻辑
        cc.log("timer %d  starDuration %d", this.timer, this.starDuration);
    ...
    onTouchEnd (event) {
        this.tounchCount++;
        this.string.myshift(this.tounchCount, this.string.degree);
        this.player1.myshift(this.tounchCount, this.string.degree);
        this.player2.myshift(this.tounchCount, this.string.degree + 180);
